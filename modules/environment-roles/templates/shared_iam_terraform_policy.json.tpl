  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:iam::${account_id}:policy/TDRCreateKeycloakUsersPolicy${title(environment)}",
        "arn:aws:iam::${account_id}:policy/TDRCreateKeycloakUsersApiPolicy${title(environment)}",
        "arn:aws:iam::${account_id}:policy/TDRCreateKeycloakUsersS3Policy${title(environment)}",
        ...
        "arn:aws:iam::${account_id}:role/TDRCreateKeycloakUsersRole${title(environment)}",
        "arn:aws:iam::${account_id}:role/TDRCreateKeycloakUsersApiRole${title(environment)}",
        "arn:aws:iam::${account_id}:role/TDRCreateKeycloakUsersS3Role${title(environment)}",
