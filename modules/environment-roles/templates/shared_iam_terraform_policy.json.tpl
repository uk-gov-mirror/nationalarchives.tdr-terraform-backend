  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:iam::${account_id}:policy/TDRExportFailureStatusLambdaPolicy${title(environment)}",
        ...
        "arn:aws:iam::${account_id}:role/TDRExportFailureStatusLambdaRole${title(environment)}",
