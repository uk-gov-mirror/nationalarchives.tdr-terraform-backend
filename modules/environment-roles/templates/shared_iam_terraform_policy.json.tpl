  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:iam::${account_id}:policy/TDRExportStatusUpdateLambdaPolicy${title(environment)}",
        ...
        "arn:aws:iam::${account_id}:role/TDRBackendChecksAPIRole${title(environment)}",
        ...
        "arn:aws:iam::${account_id}:role/TDRExportStatusUpdateLambdaRole${title(environment)}",
